...
const Feed = () => {
  ...
  return (
    <div className='max-lg:flex flex-col items-center min-h-[90vh]'>
      <article className="lg:absolute left-[5%] top-[13%] lg:w-[22%] max-sm:min-w-[95%] rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-lg ">
      ...
      <div className={`flex flex-row container max-sm:w-fit ${isPopupVisible ? 'blur-sm' : ''}`}>
        <div className="mx-auto p-4 max-sm:p-1 lg:w-[45%] md:w-[70%] sm:w-[90%] max-sm:w-fit">
          ...
          <div onClick={togglePopup} className="bg-white shadow-md rounded-lg p-4 mb-6 border border-gray-600 max-sm:min-w-[95%] max-sm:m-auto max-sm:my-4">
            <div className="flex items-center gap-4 ">
