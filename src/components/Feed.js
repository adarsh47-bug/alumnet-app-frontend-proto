    ...
    <div className='max-lg:flex flex-col items-center'>
      <article className="lg:absolute left-[5%] top-[13%] lg:w-[22%] rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-lg ">
        ...
        <ul className="mt-4 space-y-2">
          ...
          <li><Link to="/" className="block h-full rounded-lg my-1 border border-gray-700 p-4 hover:border-pink-600"><strong className="font-medium text-white flex items-center justify-between">My feeds & bookmarks<span class="material-icons px-2">bookmark</span></strong></Link></li>
      ...
      <div className={`flex flex-row container ${isPopupVisible ? 'blur-sm' : ''}`}>
        <div className="mx-auto p-4 lg:w-[45%] md:w-[70%] sm:w-[90%]">
          ...
          <div onClick={togglePopup} className="bg-white shadow-md rounded-lg p-4 mb-6 border border-gray-600">
            <div className="flex items-center gap-4">
              ...
              <button className='rounded-lg w-fit bg-blue-400 text-white font-semibold text-sm p-2 flex items-center justify-between'>Create <span class="material-icons px-2">create</span></button>
            </div>
          </div>
